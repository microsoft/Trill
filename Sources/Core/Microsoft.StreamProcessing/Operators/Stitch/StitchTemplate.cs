...
// TKey: ");
    ...
    ");
            ...
            this.Write(">(true /*stream.Properties.IsColumnar*/);\r\n        this.queryPlanGenerator = quer" +
                    "yPlanGenerator;\r\n        GetOutputBatch();\r\n\r\n        //var khpcomparer = Equali" +
                    "tyComparerExtensions.GetCompoundEqualityComparerExpression<KHP, ");
            this.Write(this.ToStringHelper.ToStringWithCulture(TKey));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(TPayload));
            this.Write(@">(
 ...
 if (this.noFields) { 
    ...
    public override unsafe void OnNext(StreamMessage<");
            ...
            this.Write(";\r\n\r\n        var count = input.Count;\r\n\r\n        fixed (long* src_bv = input.bitv" +
                    ...
                    "                       outputCount++;\r\n\r\n                        if (outputCount" +
                    " == Config.DataBatchSize) FlushContents();\r\n                    }\r\n             " +
                    "       else if (*vsync < *vother)\r\n                    {\r\n                      " +
                    "  ActOnStart(input, i, *vsync);\r\n                        ActOnEnd(input, i, *vsy" +
                    "nc, *vother);\r\n                    }\r\n                    else\r\n                " +
                    "    {\r\n                        ActOnEnd(input, i, *vother, *vsync);\r\n           " +
                    "         }\r\n                }\r\n\r\n                vsync++; vother++; hash++;\r\n   " +
                    "         }\r\n        }\r\n\r\n        input.Free();\r\n    }\r\n\r\n    // The \"SkipBufferi" +
                    "ng\" tells us that we\'re at the end of a round, called from \"purge\". Rather than " +
                    "buffering this, we should\r\n    // just issue it as a begin event.\r\n    private v" +
                    "oid ActOnStart(");
            this.Write(this.ToStringHelper.ToStringWithCulture(BatchGeneratedFrom_TKey_TPayload));
            this.Write(this.ToStringHelper.ToStringWithCulture(TKeyTPayloadGenericParameters));
