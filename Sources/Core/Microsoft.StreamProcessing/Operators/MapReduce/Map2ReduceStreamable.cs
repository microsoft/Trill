...
namespace Microsoft.StreamProcessing
{
    ...
    {
        private IStreamable<TMapKey, TMapInputLeft1> sourceLeft1;
        private readonly IStreamable<TMapKey, TMapInputRight1> sourceRight1;
        private IStreamable<TMapKey, TMapInputLeft2> sourceLeft2;
        ...
        public override IDisposable Subscribe(IStreamObserver<TMapKey, TOutput> observer)
        {
            ...
            if (this.sourceRight1 != null) // two-input mapper
            {
                ...
                for (int i = 0; i < mapArity; i++)
                    shuffleL1Results1[i] = new ShuffleNestedStreamable<TMapKey, TReduceInput1, TReduceKey>(this.keyComparer, sprayResults1[i], this.keySelector1, reduceArity, i);
            ...
            else // single-input mapper
            {
                ...
                if (this.reduceInMap || (this.reduceOptions == OperationalHint.Asymmetric))
                {
                    ...
                    for (int i = 0; i < mapArity; i++)
                        shuffleL2Results1[i] = new GroupNestedStreamable<TMapKey, TReduceInput1, TReduceKey>(this.keyComparer, sprayResults1[i], this.keySelector1);
                }
                else
                {
                    shuffleL2Results1 = new MultiUnionStreamable<CompoundGroupKey<TMapKey, TReduceKey>, TReduceInput1>[reduceArity];
            ...
            if (this.sourceRight2 != null) // two-input mapper
            {
                ...
                for (int i = 0; i < mapArity; i++)
                    shuffleL1Results2[i] = new ShuffleNestedStreamable<TMapKey, TReduceInput2, TReduceKey>(this.keyComparer, sprayResults2[i], this.keySelector2, reduceArity, i);
            ...
            else // single-input mapper
            {
                ...
                if (this.reduceInMap || (this.reduceOptions == OperationalHint.Asymmetric))
                {
                    ...
                    for (int i = 0; i < mapArity; i++)
                        shuffleL2Results2[i] = new GroupNestedStreamable<TMapKey, TReduceInput2, TReduceKey>(this.keyComparer, sprayResults2[i], this.keySelector2);
                }
                else
                {
                    shuffleL2Results2 = new MultiUnionStreamable<CompoundGroupKey<TMapKey, TReduceKey>, TReduceInput2>[reduceArity];
    ...
    {
        private IStreamable<Empty, TMapInputLeft1> sourceLeft1;
        private readonly IStreamable<Empty, TMapInputRight1> sourceRight1;
        private IStreamable<Empty, TMapInputLeft2> sourceLeft2;
        ...
        public override IDisposable Subscribe(IStreamObserver<Empty, TOutput> observer)
        {
            ...
            if (this.sourceRight1 != null) // two-input mapper
            {
                ...
                for (int i = 0; i < mapArity; i++)
                    shuffleL1Results1[i] = new ShuffleStreamable<Empty, TReduceInput1, TReduceKey>(this.keyComparer, sprayResults1[i], this.keySelector1, reduceArity, i);
            ...
            else // single-input mapper
            {
                ...
                if (this.reduceInMap || (this.reduceOptions == OperationalHint.Asymmetric))
                {
                    ...
                    for (int i = 0; i < mapArity; i++)
                        shuffleL2Results1[i] = new GroupStreamable<Empty, TReduceInput1, TReduceKey>(this.keyComparer, sprayResults1[i], this.keySelector1);
                }
                else
                {
                    shuffleL2Results1 = new MultiUnionStreamable<TReduceKey, TReduceInput1>[reduceArity];
            ...
            if (this.sourceRight2 != null) // two-input mapper
            {
                ...
                for (int i = 0; i < mapArity; i++)
                    shuffleL1Results2[i] = new ShuffleStreamable<Empty, TReduceInput2, TReduceKey>(this.keyComparer, sprayResults2[i], this.keySelector2, reduceArity, i);
            ...
            else // single-input mapper
            {
                ...
                if (this.reduceInMap || (this.reduceOptions == OperationalHint.Asymmetric))
                {
                    ...
                    for (int i = 0; i < mapArity; i++)
                        shuffleL2Results2[i] = new GroupStreamable<Empty, TReduceInput2, TReduceKey>(this.keyComparer, sprayResults2[i], this.keySelector2);
                }
                else
                {
                    shuffleL2Results2 = new MultiUnionStreamable<TReduceKey, TReduceInput2>[reduceArity];
