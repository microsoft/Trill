...
{
    internal partial class ClipByConstantTemplate
    {
        protected static int ClipByConstantSequenceNumber = 0;

        private ClipByConstantTemplate(string className, Type keyType, Type payloadType)
