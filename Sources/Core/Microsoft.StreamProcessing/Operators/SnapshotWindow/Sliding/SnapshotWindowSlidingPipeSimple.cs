...
namespace Microsoft.StreamProcessing
{
    ...
    /// </summary>
    [DataContract]
    internal sealed class SnapshotWindowSlidingPipeSimple<TInput, TState, TOutput> : UnaryPipe<Empty, TInput, TOutput>
    {
        ...
        [DataMember]
        private ElasticCircularBuffer<HeldState<TState>> ecq;
        [DataMember]
