...
{
    [DataContract]
    internal sealed class SessionTimeoutWindowPipeStateless<TKey, TPayload> : UnaryPipe<TKey, TPayload, TPayload>
    {
        ...
        public SessionTimeoutWindowPipeStateless() { }

        public SessionTimeoutWindowPipeStateless(IStreamable<TKey, TPayload> stream, IStreamObserver<TKey, TPayload> observer, long sessionTimeout, long maximumDuration)
