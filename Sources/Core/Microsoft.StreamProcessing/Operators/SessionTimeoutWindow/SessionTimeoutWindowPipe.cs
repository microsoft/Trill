...
{
    [DataContract]
    internal sealed class SessionTimeoutWindowPipe<TKey, TPayload> : UnaryPipe<TKey, TPayload, TPayload>
    {
        ...
        public SessionTimeoutWindowPipe() { }

        public SessionTimeoutWindowPipe(IStreamable<TKey, TPayload> stream, IStreamObserver<TKey, TPayload> observer, long sessionTimeout, long maximumDuration)
