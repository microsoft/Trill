...
{
    internal sealed class SessionTimeoutWindowStreamable<TKey, TPayload> : UnaryStreamable<TKey, TPayload, TPayload>
    {
        ...
        public SessionTimeoutWindowStreamable(IStreamable<TKey, TPayload> source, long sessionTimeout, long maximumDuration)
        ...
        internal override IStreamObserver<TKey, TPayload> CreatePipe(IStreamObserver<TKey, TPayload> observer)
        {
            ...
            if (t == null)
            {
                ...
                if (typeof(TKey) == typeof(Empty))
                    return new SessionTimeoutWindowPipeStateless<TKey, TPayload>(this, observer, this.sessionTimeout, this.maximumDuration);
                else
                    return new SessionTimeoutWindowPipe<TKey, TPayload>(this, observer, this.sessionTimeout, this.maximumDuration);
            }
            var outputType = typeof(PartitionedSessionTimeoutWindowPipe<,,>).MakeGenericType(
                typeof(TKey),
                typeof(TPayload),
                t);
        ...
        protected override bool CanGenerateColumnar()
        {
            ...
            var generatedPipeType = cachedPipes.GetOrAdd(lookupKey, key => SessionTimeoutWindowTemplate.Generate(this));
        ...
        private UnaryPipe<TKey, TPayload, TPayload> GetPipe(IStreamObserver<TKey, TPayload> observer)
        {
            ...
            var generatedPipeType = cachedPipes.GetOrAdd(lookupKey, key => SessionTimeoutWindowTemplate.Generate(this));
            Func<PlanNode, IQueryObject, PlanNode> planNode = ((PlanNode p, IQueryObject o) => new SessionTimeoutWindowPlanNode(p, o, typeof(TKey), typeof(TPayload), this.sessionTimeout, this.maximumDuration, true, generatedPipeType.Item2));
