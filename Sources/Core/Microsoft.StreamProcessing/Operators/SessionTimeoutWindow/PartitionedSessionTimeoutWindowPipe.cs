...
{
    [DataContract]
    internal sealed class PartitionedSessionTimeoutWindowPipe<TKey, TPayload, TPartitionKey> : UnaryPipe<TKey, TPayload, TPayload>
    {
        ...
        public PartitionedSessionTimeoutWindowPipe() { }

        public PartitionedSessionTimeoutWindowPipe(IStreamable<TKey, TPayload> stream, IStreamObserver<TKey, TPayload> observer, long sessionTimeout, long maximumDuration)
        ...
        public override void ProduceQueryPlan(PlanNode previous)
            => this.Observer.ProduceQueryPlan(new SessionTimeoutWindowPlanNode(
                previous, this,
