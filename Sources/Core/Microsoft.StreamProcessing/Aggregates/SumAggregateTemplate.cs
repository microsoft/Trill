...
namespace Microsoft.StreamProcessing.Aggregates
{
    ...
    internal class SumSByteAggregate : ISummableAggregate<sbyte, sbyte, sbyte>
    {
        public Expression<Func<sbyte>> InitialState() => () => 0;

        public Expression<Func<sbyte, long, sbyte, sbyte>> Accumulate()
            => (oldSum, timestamp, input) => (sbyte)(oldSum + input);
    ...
    internal class SumByteAggregate : ISummableAggregate<byte, byte, byte>
    {
        public Expression<Func<byte>> InitialState() => () => 0;

        public Expression<Func<byte, long, byte, byte>> Accumulate()
            => (oldSum, timestamp, input) => (byte)(oldSum + input);
    ...
    internal class SumShortAggregate : ISummableAggregate<short, short, short>
    {
        public Expression<Func<short>> InitialState() => () => 0;

        public Expression<Func<short, long, short, short>> Accumulate()
            => (oldSum, timestamp, input) => (short)(oldSum + input);
    ...
    internal class SumUShortAggregate : ISummableAggregate<ushort, ushort, ushort>
    {
        public Expression<Func<ushort>> InitialState() => () => 0;

        public Expression<Func<ushort, long, ushort, ushort>> Accumulate()
            => (oldSum, timestamp, input) => (ushort)(oldSum + input);
    ...
    internal class SumIntAggregate : ISummableAggregate<int, int, int>
    {
        public Expression<Func<int>> InitialState() => () => 0;

        public Expression<Func<int, long, int, int>> Accumulate()
            => (oldSum, timestamp, input) => (int)(oldSum + input);
    ...
    internal class SumUIntAggregate : ISummableAggregate<uint, uint, uint>
    {
        public Expression<Func<uint>> InitialState() => () => 0;

        public Expression<Func<uint, long, uint, uint>> Accumulate()
            => (oldSum, timestamp, input) => (uint)(oldSum + input);
    ...
    internal class SumLongAggregate : ISummableAggregate<long, long, long>
    {
        public Expression<Func<long>> InitialState() => () => 0;

        public Expression<Func<long, long, long, long>> Accumulate()
            => (oldSum, timestamp, input) => (long)(oldSum + input);
    ...
    internal class SumULongAggregate : ISummableAggregate<ulong, ulong, ulong>
    {
        public Expression<Func<ulong>> InitialState() => () => 0;

        public Expression<Func<ulong, long, ulong, ulong>> Accumulate()
            => (oldSum, timestamp, input) => (ulong)(oldSum + input);
    ...
    internal class SumFloatAggregate : ISummableAggregate<float, float, float>
    {
        public Expression<Func<float>> InitialState() => () => 0;

        public Expression<Func<float, long, float, float>> Accumulate()
            => (oldSum, timestamp, input) => (float)(oldSum + input);
    ...
    internal class SumDoubleAggregate : ISummableAggregate<double, double, double>
    {
        public Expression<Func<double>> InitialState() => () => 0;

        public Expression<Func<double, long, double, double>> Accumulate()
            => (oldSum, timestamp, input) => (double)(oldSum + input);
    ...
    internal class SumDecimalAggregate : ISummableAggregate<decimal, decimal, decimal>
    {
        public Expression<Func<decimal>> InitialState() => () => 0;

        public Expression<Func<decimal, long, decimal, decimal>> Accumulate()
            => (oldSum, timestamp, input) => (decimal)(oldSum + input);
    ...
    internal class SumBigIntegerAggregate : ISummableAggregate<BigInteger, BigInteger, BigInteger>
    {
        public Expression<Func<BigInteger>> InitialState() => () => 0;

        public Expression<Func<BigInteger, long, BigInteger, BigInteger>> Accumulate()
            => (oldSum, timestamp, input) => (BigInteger)(oldSum + input);
    ...
    internal class SumComplexAggregate : ISummableAggregate<Complex, Complex, Complex>
    {
        public Expression<Func<Complex>> InitialState() => () => 0;

        public Expression<Func<Complex, long, Complex, Complex>> Accumulate()
            => (oldSum, timestamp, input) => (Complex)(oldSum + input);
