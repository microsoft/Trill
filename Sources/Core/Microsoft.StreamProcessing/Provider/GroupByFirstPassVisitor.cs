...
namespace Microsoft.StreamProcessing.Provider
{
    ...
    /// </summary>
    internal sealed class GroupByFirstPassVisitor : ExpressionVisitor
    {
        ...
        public static LambdaExpression CreateConstructorFromSelect(LambdaExpression selectExpression)
        {
            ...
            var visitor = new GroupByFirstPassVisitor(
        ...
        private GroupByFirstPassVisitor(ParameterExpression inputVariable, Type groupingKeyType, Type elementType)
        {
        ...
        protected override Expression VisitMember(MemberExpression node)
            => node.Expression == this.inputVariable && node.Member.Name == "Key"
                ? Expression.PropertyOrField(windowParameter, "Key")
